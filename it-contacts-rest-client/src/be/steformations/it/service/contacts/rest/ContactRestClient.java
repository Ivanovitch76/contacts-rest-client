...
import be.steformations.it.java_data.contacts.dto.ContactDtoFactory;
...
public class ContactRestClient {
	...
	public ContactRestClient() {
		super();
		this.service = javax.ws.rs.client.ClientBuilder.newClient().target("http://localhost:8080/contacts-rest/rs");
		this.contactDtoFactory = new ContactDtoFactory();
	}
	...
	public TagDto getTagById (int id){ 
		...
		TagDto temp = this.contactDtoFactory.xmlToTag(xml);
		if (temp.getId() != null){
			dto = temp;
		}
	...
	public TagDto getTagByValue(String value){
		...
		javax.ws.rs.core.Response response = this.service.path("tag").path(value)
				.request(javax.ws.rs.core.MediaType.APPLICATION_XML)
				.get();
	...
	public java.util.List<TagDto> getAllTags(){
		...
		javax.ws.rs.core.Response response = this.service.path("tag")
				.request(javax.ws.rs.core.MediaType.APPLICATION_XML)
				.get();
	...
	public boolean removeTag(int id){
		...
		javax.ws.rs.core.Response response = this.service.path("tag").path("delete").path(String.valueOf(id))
				.request().delete();
	...
	public CountryDto createAndSaveCountry(String abbreviation, String name){
		...
		javax.ws.rs.client.Entity<javax.ws.rs.core.MultivaluedMap<String, String>> entity
			= javax.ws.rs.client.Entity.entity(form, javax.ws.rs.core.MediaType.APPLICATION_FORM_URLENCODED);
		javax.ws.rs.core.Response response 		
		= this.service.path("country")
			.request(javax.ws.rs.core.MediaType.APPLICATION_JSON)
			.post(entity);
	...
	public ContactDto createAndSaveContact(String firstname, String name, String email, String countryAbbreviation, java.util.List<String> tagValues){
		ContactDto contactDto = null;
		...
		javax.ws.rs.client.Entity<ContactDto> entity
			= javax.ws.rs.client.Entity.entity(input, javax.ws.rs.core.MediaType.APPLICATION_XML);
